...
`*Examine 'com.redhat.cloudnative.catalog.CatalogApplication' class*` in the **/projects/catalog/labs/catalog-spring-boot/src/main** directory:
...
**/projects/catalog/labs/catalog-spring-boot/src/main/resources/application.properties**. Examine this file to see the database connection details 
...
Once successfully built, the resulting **catalog-1.0-SNAPSHOT.jar** is located in the **/projects/catalog/labs/catalog-spring-boot/target/** directory.
...
In your {CHE_URL}[Workspace^], `*create the '/projects/catalog/labs/catalog-spring-boot/src/main/java/com/redhat/cloudnative/catalog/Product.java' file`* 
...
`*create the '/projects/catalog/labs/catalog-spring-boot/src/main/java/com/redhat/cloudnative/catalog/ProductRepository.java' file`*.
...
In your {CHE_URL}[Workspace^], 
`*create the '/projects/catalog/labs/catalog-spring-boot/src/main/java/com/redhat/cloudnative/catalog/CatalogController.java' file`*.
...
|Select binary file
|$(file-zip) labs/catalog-spring-boot/catalog-1.0-SNAPSHOT.jar
