...
----
oc annotate route/web-coolstore haproxy.router.openshift.io/balance=roundrobin -n cn-project{USER_ID}
----
====
...
.>_ workshop-tools terminal
----
oc set resources dc/web-coolstore --limits=cpu=400m,memory=512Mi --requests=cpu=200m,memory=256Mi -n cn-project{USER_ID}
----
...
.>_ workshop-tools terminal
----
oc autoscale dc/web-coolstore --min 1 --max 5 --cpu-percent=40 -n cn-project{USER_ID}
----
...
.>_ workshop-tools terminal
----
ab -c 100 -n 80000 -s 5 http://web-coolstore.cn-project{USER_ID}.svc:8080/
----
...
.>_ workshop-tools terminal
----
oc get pods -l deploymentconfig=catalog-coolstore -n cn-project{USER_ID}
----
...
.>_ workshop-tools terminal
----
oc delete pods -l deploymentconfig=catalog-coolstore -n cn-project{USER_ID}
----
