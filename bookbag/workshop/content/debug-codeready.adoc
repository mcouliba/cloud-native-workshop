...
image::images/debug-che-debug-config-1.png[Remote Debug,600]

The window shows the debuggers available in CodeReady Workspaces. Click on the plus sign near the 
Java debugger.

image::images/debug-che-debug-config-2.png[Remote Debug,700]
...
image::images/debug-che-debug-config-3.png[Remote Debug,700]
...
image::images/debug-che-debug-config-4.png[Remote Debug,360]
...
image::images/debug-che-breakpoint.png[Add Breakpoint,600]
...
image::images/debug-che-window-guide.png[Icons,700]
...
image::images/debug-che-breakpoint-stop.png[Icons,900]
...
image::images/debug-che-step-over.png[Step Over,340]
...
image::images/debug-che-variables.png[Watch Variables,500]

image::images/debug-che-breakpoint-values.png[Debug,900]
...
OpenShift Web Console and inside the **cn-project{USER_ID}** project. On the sidebar 
