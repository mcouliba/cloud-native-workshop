...
Let's add the needed dependencies to **/projects/inventory/labs/inventory-quarkus/pom.xml**. 
In your {CHE_URL}[Workspace^], `*edit the '/projects/inventory/labs/inventory-quarkus/pom.xml' file*`:
