...
`*click on 'Advanced' -> 'Projects' then select your 'my-project{USER_ID}' project*`.

In the project overview, you can see the **Health** and **Resource Usage** sections

image::images/health-metrics-brief.png[Container Metrics,740]
...
image::images/health-metrics-detailed.png[Container Metrics,900]
