...
image::images/che-openshift-login-popup.png[Che - OpenShift View, 500]
...
image::images/che-openshift-login.png[Che - OpenShift View, 300]

* The **'cn-project{USER_ID}' project** will be used as a **Staging Environment**.
* The **'user{USER_ID}-che' project** contains your **Developer Workspace** up and running
