...
quarkus.datasource.url=jdbc:mariadb://inventory-mariadb.my-project{USER_ID}.svc:3306/inventorydb# <1>
...
.>_ workshop-tools terminal
----
oc create configmap inventory --from-file=application.properties=/projects/inventory-openshift-application.properties -n my-project{USER_ID}# <1>
oc label configmap inventory app=coolstore app.kubernetes.io/instance=inventory -n my-project{USER_ID} # <2>
oc set volume dc/inventory-coolstore --add --configmap-name=inventory --mount-path=/deployments/config -n my-project{USER_ID}# <3>
----
...
spring.datasource.url=jdbc:postgresql://catalog-postgresql.my-project{USER_ID}.svc:5432/catalogdb#<1>
