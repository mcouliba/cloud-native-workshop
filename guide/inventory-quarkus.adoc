...
image:{% image_path che-localhost-8080.png %}[Che - Localhost 8080, 500]

A new tab will be opened in your browser pointing to the service running on your Workspace.
...
image:{% image_path che-quarkus-homepage.png %}[Che - Quarkus - Home Page, 500]
