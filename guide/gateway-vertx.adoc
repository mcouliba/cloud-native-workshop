...
----
$ ls /projects/workshop/labs/gateway-vertx/target/*.jar

/projects/workshop/labs/gateway-vertx/target/gateway-1.0-SNAPSHOT.jar
----
...
In the {{OPENSHIFT_CONSOLE_URL}}[OpenShift Web Console^], `*click on 'DC gateway' -> 'RT gateway'*`
