...
image:{% image_path argocd-home.png %}[Argo CD - Home Page, 800]
...
image::{% image_path argocd-configure-repository.png  %}[Argo CD - Configure Repository, 300]
...
image::{% image_path argocd-repository.png  %}[Argo CD - Repository, 300]

'''

=== Create a GitOps Application

image:{% image_path argocd-manage-application.png %}[Argo CD - Home Page, 800]
